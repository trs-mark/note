...
Ti.include(
    '/acs/windows/chats/table.js',
    '/acs/windows/checkins/table.js',
    '/acs/windows/clients/table.js',
    '/acs/windows/customObjects/table.js',
    '/acs/windows/emails/table.js',
    '/acs/windows/events/table.js',
    '/acs/windows/files/table.js',
    '/acs/windows/friends/table.js',
    '/acs/windows/geoFences/table.js',
    '/acs/windows/photoCollections/table.js',
    '/acs/windows/photos/table.js',
    '/acs/windows/places/table.js',
    '/acs/windows/posts/table.js',
    '/acs/windows/keyValues/table.js',
    '/acs/windows/likes/table.js',
    '/acs/windows/messages/table.js',
    '/acs/windows/pushNotifications/table.js',
    '/acs/windows/pushSchedules/table.js',
    '/acs/windows/reviews/table.js',
    '/acs/windows/social/table.js',
    '/acs/windows/status/table.js',
    '/acs/windows/users/table.js',
    '/acs/windows/accessControlLists/table.js'
);
